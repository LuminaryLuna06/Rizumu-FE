  ...
  return (
    ...
    >
      <div
        className={`${(
          className || ""
        ).trim()} mx-sm md:mx-xl w-full max-w-[800px] max-h-[80%] bg-modal-overlay text-secondary rounded-3xl shadow-2xl p-md md:p-xl border border-gray-800 relative animate-dropdown font-poppins`}
