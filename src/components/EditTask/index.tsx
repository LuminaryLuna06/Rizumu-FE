...
import Modal from "../Modal"; // Đảm bảo đường dẫn import đúng file Modal gốc của bạn
import {
  IconTag,
  IconClock,
  IconList,
...
const EditTask: React.FC<EditTaskProps> = ({ opened, onClose }) => {
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6 font-sans">
        ...
        {/* --- Footer --- */}
        <div className="flex justify-end items-center gap-4 mt-4 pt-4 border-t border-gray-900 sticky bottom-0 z-10 bg-[#121212]">
          <button
            onClick={onClose}
            className="px-6 py-2 text-white hover:text-gray-300 font-medium transition"
          >
            Cancel
          </button>
          <button
            ...
            className="px-8 py-2 bg-white text-black rounded-xl font-bold hover:bg-gray-200 transition"
          >
            Save
          </button>
        </div>
