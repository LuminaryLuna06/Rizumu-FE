...
function OnlineUsers({ members }: OnlineUsersProps) {
  ...
  return (
    <div className="fixed top-20 right-4">
      <div className="flex items-center gap-2 bg-primary/80 backdrop-blur-xl border border-primary/50 rounded-2xl px-4 py-2 shadow-lg">
          ...
          {onlineMembers.slice(0, 5).map((member) => (
            ...
            >
              {member.avatar ? (
                ...
                <div className="w-8 h-8 rounded-full border-2 border-primary ring-2 ring-green-500/50 bg-secondary flex items-center justify-center text-xs font-bold hover:scale-110 transition-transform cursor-pointer">
